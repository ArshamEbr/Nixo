{ pkgs, config, lib, user, ... }:{
  ...
  dotfiles = {
      ...
      #  bind = $Primary, A, exec, rofi -show drun
        ...
        bind = $Primary$Alternate, 7, exec, check_gpu_status
        bind = $Primary$Alternate, 8, exec, power-save
        ...
        bind = $Alternate, B, exec, brave
        bind = $Primary, B, exec, zen
        ...
        bind = $Primary$Tertiary, Q, exec, hyprctl kill
